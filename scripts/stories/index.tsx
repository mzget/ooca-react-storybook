...
storiesOf("OOCA-provider-modals/FollowUp", module)
  .add("FollowModal", () =>
    <FollowUpPlanDialogWithTheme isLocal={"EN"} onSubmit={(value) => { console.log(value); action(value); }} />)
  .add("FollowModal-TH", () =>
    <FollowUpPlanDialogWithTheme isLocal={"TH"} onSubmit={(value) => { console.log(value); action(value); }} />)
  .add("FollowUpSuccess", () =>
    <FollowUpSuccessDialogWithTheme isLocal={"EN"} isProvider={true}
