...
class ServerEventListener {
    ...
    addServerListener(obj) {
        ...
        // <!-- User -->
        self.socket.on(_1.StalkEvents.ON_USER_LOGIN, data => {
            console.log(_1.StalkEvents.ON_USER_LOGIN);
            self.serverListener.onUserLogin(data);
        });
        self.socket.on(_1.StalkEvents.ON_USER_LOGOUT, data => {
            console.log(_1.StalkEvents.ON_USER_LOGOUT);
    ...
    addChatListener(obj) {
        ...
        let self = this;
        self.socket.on(_1.ChatEvents.ON_CHAT, function (data) {
            console.log(_1.ChatEvents.ON_CHAT, JSON.stringify(data));
            self.chatServerListener.onChat(data);
        });
        self.socket.on(_1.ChatEvents.ON_ADD, (data) => {
            console.log(_1.ChatEvents.ON_ADD, data);
            self.chatServerListener.onRoomJoin(data);
        });
        self.socket.on(_1.ChatEvents.ON_LEAVE, (data) => {
            console.log(_1.ChatEvents.ON_LEAVE, data);
            self.chatServerListener.onLeaveRoom(data);
        });
        self.socket.on(_1.ChatEvents.ON_GET_MESSAGES_READERS, (data) => {
            console.log(_1.ChatEvents.ON_GET_MESSAGES_READERS);
    ...
    addPushListener(obj) {
        ...
        let self = this;
        self.socket.on(_1.PushEvents.ON_PUSH, function (data) {
