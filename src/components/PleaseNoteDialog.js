...
import { PrimaryDialogButton, ContentDialog, DialogHeader } from './DialogContent';
export class PleaseNoteDialog extends React.Component {
    ...
    render() {
        ...
        return (<MuiThemeProvider muiTheme={defaultMuiTheme}>
                <Dialog contentStyle={{ maxWidth: '500px', minWidth: '400px' }} titleStyle={{ fontWeight: 'bold', textAlign: 'center' }} bodyStyle={{ textAlign: 'center' }} actionsContainerStyle={{ padding: 0 }} actions={[
            <PrimaryDialogButton style={{ width: '100%', textAlign: 'center' }} onClick={() => {
